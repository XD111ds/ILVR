...
<!-- Please make sure you have created the 'assets' folder and uploaded 'framework.png' -->
...
This project uses HuggingFace accelerate for distributed training.
...
We utilize the CoMT dataset (Chain of Multi-modal Thought). For more details about the benchmark, please refer to the CoMT paper.

Download Data

We provide the processed data on HuggingFace. Please download it from shuai22/comt and organize the directory as follows.

Download TRAIN.jsonl, TEST.jsonl, and comt.tar.gz.

Extract the images from the tarball.
...
This codebase is built upon Qwen-VL and Transformers. We thank the authors for their open-source contributions.
